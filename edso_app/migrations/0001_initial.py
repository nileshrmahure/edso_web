# Generated by Django 3.2.25 on 2024-12-31 06:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enrolled_courses', models.ManyToManyField(to='edso_app.Course')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='edso_app.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='Member',
